...
// 🔥 Hero solo en cliente (sin SSR) para evitar el hydration mismatch
...
export default function HomePage() {
  ...
  const valuesList = t(
    "missionVisionValues.valuesList"
  ...
  return (
    <div className="bg-[#0F0F0F] text-white">
      ...
      {/* ⭐ BENEFICIOS */}
      <section className="bg-[#111315] border-b border-[#2a2a2a]">
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-20">
          <div className="grid md:grid-cols-3 gap-6">
            {benefits.map((txt, i) => (
              <div
                key={i}
                className="p-6 rounded-xl bg-[#1A1A1A] text-center border border-[#2f2f2f] shadow-md hover:border-red-600/60 transition-all"
              >
      ...
      <section className="bg-[#111315] border-b border-[#2a2a2a]">
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-20">
          <h2 className="text-center text-3xl font-bold text-red-600 mb-10 md:mb-12">
      ...
      <section className="bg-[#111315] border-b border-[#2a2a2a]">
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-20 text-center">
          ...
          <a
            ...
            className="inline-block mt-6 px-8 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg shadow-md hover:shadow-red-700/40 transition"
          >
            {t("home.footerButton")}
          </a>
        </div>
      ...
      {/* ⭐ Secciones completas adicionales */}
      <ServicesPage />
      <AboutPage />
